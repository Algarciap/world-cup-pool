...
An internal office prediction pool for the 2026 World Cup. Participants submit score predictions for all group-stage matches and pick knockout-round winners. Points are awarded automatically as results come in, and a live leaderboard tracks the standings.
...
- **Leaderboard** — live points with rank-movement indicators (▲/▼)
...
```
app.py                  # Home page — login and welcome screen
...
pages/
  ...
  3_Leaderboard.py      # Live standings
